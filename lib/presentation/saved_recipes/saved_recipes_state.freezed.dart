...
SavedRecipesState _$SavedRecipesStateFromJson(Map<String, dynamic> json) {
  return _SavedRecipesState.fromJson(json);
}
...
mixin _$SavedRecipesState {
  ...
  /// Serializes this SavedRecipesState to a JSON map.
...
class _$SavedRecipesStateImpl implements _SavedRecipesState {
  ...
  factory _$SavedRecipesStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$SavedRecipesStateImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$SavedRecipesStateImplToJson(
      this,
    );
  }
}
...
abstract class _SavedRecipesState implements SavedRecipesState {
  factory _SavedRecipesState(
      {final List<Recipe> recipes,
      final bool isLoading}) = _$SavedRecipesStateImpl;

  factory _SavedRecipesState.fromJson(Map<String, dynamic> json) =
      _$SavedRecipesStateImpl.fromJson;
